...
int main(){
	...
	cout<<"Tamaño de la lista: " <<miLista.tamano() <<endl <<endl;
	...
	miListaDouble.adjuntar(1, 101.7);
	cout<<"La lista es: " <<miListaDouble.comoCadena() <<endl <<endl;
	
	miListaDouble.adjuntar(2, 365.50);
	cout<<"La lista es: " <<miListaDouble.comoCadena() <<endl <<endl;
	
	cout<<"Tamaño de lista: " <<miListaDouble.tamano() <<endl <<endl;
	
	cout<<miListaDouble.obtener(4) <<endl <<endl;
	
	cout<<miListaDouble.remover(2) <<endl <<endl;
	out<<"La lista es: " <<miListaDouble.comoCadena() <<endl <<endl;
